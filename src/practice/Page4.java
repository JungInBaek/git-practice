...
public class Page4 {
	...
	public void open() {
		...
		JOptionPane.showMessageDialog(null, "ID와 PW를 입력하시고 조회를 누른 후 데이터를 수정할 수 있습니다.", "스탭관리", -1);
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					if (a.equals("STAFF")) {
						...
						JOptionPane.showMessageDialog(null, b + "는 스탭입니다.");
						b2.setEnabled(true);
						t3.setEditable(true);
						t4.setEditable(true);
						...
						JOptionPane.showMessageDialog(null, b + "는 고객입니다.");
						System.out.println(a);
						b2.setEnabled(false);
					}
				} catch (Exception e) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(null, "아이디와 비밀번호가 일치하지 않습니다.", "로그인오류", 0);
				}
